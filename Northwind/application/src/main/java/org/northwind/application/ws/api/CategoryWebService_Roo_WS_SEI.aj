...
import org.northwind.application.ws.api.CategoryWebService;
...
privileged aspect CategoryWebService_Roo_WS_SEI {
    ...
    declare @type: CategoryWebService: @WebService(name = "CategoryWebService", targetNamespace = "http://ws.northwind.org/");
     ...
     */
    @XmlJavaTypeAdapter(PageAdapter.class)
    @RequestWrapper(className = "org.northwind.application.ws.api.FindAllByIdsInByListAndGlobalSearchAndPageableRequest", localName = "FindAllByIdsInByListAndGlobalSearchAndPageableRequest", targetNamespace = "http://ws.northwind.org/")
    @ResponseWrapper(className = "org.northwind.application.ws.api.FindAllByIdsInByListAndGlobalSearchAndPageableResponse", localName = "FindAllByIdsInByListAndGlobalSearchAndPageableResponse", targetNamespace = "http://ws.northwind.org/")
