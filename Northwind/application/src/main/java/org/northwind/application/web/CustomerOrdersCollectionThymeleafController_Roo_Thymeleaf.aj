...
import org.northwind.application.web.CustomerOrdersItemThymeleafLinkFactory;
...
privileged aspect CustomerOrdersCollectionThymeleafController_Roo_Thymeleaf {
    ...
    public void CustomerOrdersCollectionThymeleafController.initCustomerOrderBinder(WebDataBinder binder) {
